...
import { validateMealPlan } from "./meal/validateMealPlan";
import { useEffect, useMemo } from "react";
import useUserStore from "../../store/useUserStore";

const DietPlanDashboard = ({ data }) => {
  const { gotPerfectMeal, setGotPerfectMeal } = useUserStore();
  ...
  useEffect(() => {
    const response = validateMealPlan(meals);
    setGotPerfectMeal(response);
  }, [ meals, setGotPerfectMeal]);

...
const GenerateDiet = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-200 to-yellow-300 pt-4 ">
      <div className="w-10/12 bg-white shadow-lg rounded-lg p-8 text-center ">
        ...
        <p className="font-semibold text-sm opacity-80 mb-8">If the genie failed please do try again cause its not you it us 👀</p>
        <button
